...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('Richard_Boolean'));
		add(ngSpr);
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['Boolean PsychEngine'], 15);
					#else
				...
				// credTextShit.screenCenter();
				case 6:
					createCoolText(['Based on Psych Engine 0.6.3', ''], -40);
				case 8:
					addMoreText('by Shadow Mario', 15);
