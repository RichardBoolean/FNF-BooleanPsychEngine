...
class CharacterEditorState extends MusicBeatState
{
	...
	function reloadBGs() {
		...
		if(onPixelBG) {
			...
			var standard:FlxSprite = new BGSprite('editor_standard', -650 + OFFSET_X - playerXDifference+1440, 500-210, 0.9, 0.9);
			standard.antialiasing = ClientPrefs.globalAntialiasing;
			bgLayer.add(standard);
	
			var standard_opponent:FlxSprite = new BGSprite('editor_standard', -650 + OFFSET_X - playerXDifference+750, 500-210, 0.9, 0.9);
			standard_opponent.antialiasing = ClientPrefs.globalAntialiasing;
			standard_opponent.flipX = true;
			bgLayer.add(standard_opponent);
